...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen pt-[76px] overflow-hidden bg-[#060c1a] z-[1]">
      ...
      {/* Dark overlay — light enough for video to show, dense enough for text */}
      ...
      <div className="absolute inset-0 flex items-center justify-end pr-8 lg:pr-20 pointer-events-none z-[3]">
        ...
        >
          ...
          {/* Corner brackets */}
          <div className="absolute top-2 left-2 w-6 h-6 border-t-2 border-l-2 border-[hsl(214_72%_60%/0.6)]" />
          <div className="absolute top-2 right-2 w-6 h-6 border-t-2 border-r-2 border-[hsl(214_72%_60%/0.6)]" />
          <div className="absolute bottom-2 left-2 w-6 h-6 border-b-2 border-l-2 border-[hsl(214_72%_60%/0.6)]" />
          <div className="absolute bottom-2 right-2 w-6 h-6 border-b-2 border-r-2 border-[hsl(214_72%_60%/0.6)]" />
        </motion.div>
      </div>
      ...
      {/* Left gradient — heavy on left for text, fades away on right so video shows */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#060c1a] via-[#060c1a]/70 via-40% to-transparent pointer-events-none z-[4]" />
      ...
      <div className="relative z-10 flex flex-col justify-center min-h-[calc(100vh-76px)] px-6 sm:px-12 md:px-16 lg:px-20 max-w-3xl">
        ...
        <motion.p
          ...
          className="text-[14px] sm:text-[15px] leading-[1.75] text-white/70 max-w-lg mb-9 border-l-2 border-[hsl(214_72%_50%/0.7)] pl-4"
        >
