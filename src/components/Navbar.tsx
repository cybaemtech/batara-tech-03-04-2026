...
const servicesItems = [
  ...
  { label: "Engineering Design & Analysis", href: "/services#engineering-design", icon: Compass },
  { label: "Manufacturing Engineering – BIW, Mould & Sheet Metal", href: "/services#manufacturing-engineering", icon: Factory },
  { label: "Integrated Project Delivery", href: "/services#integrated-project-delivery", icon: GitBranch },
  { label: "Technical Animation & Publication", href: "/services#technical-animation", icon: Film },
  { label: "Electronics Manufacturing (PCB & Electromechanical)", href: "/services#electronics-manufacturing", icon: CircuitBoard },
    ...
    <nav className="fixed top-0 left-0 right-0 z-[100] flex items-center justify-between px-6 lg:px-10 h-[76px] bg-card/95 backdrop-blur-xl border-b border-border">
      ...
      <ul className="hidden lg:flex items-center gap-7 list-none">
        ...
        <li className="relative group">
          {(() => {
            const servicesPaths = ["/solutions", "/services", "/mould-design", "/technical-gallery"];
